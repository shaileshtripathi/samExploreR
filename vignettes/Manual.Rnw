...
<<Run-samExplore>>=
 ...
 ## perform subsampling
inpf <- system.file("testdata", "Test1.sam", package="samExploreR")
...
Similar to \Rcode{exploreRob}, the function $exploreRep$ allows the exploration of the reproducibility of results. This function runs a one-way ANOVA test for groups of replicates, corresponding to one \Rcode{f} value, across various annotation types. Thus, the influence of the annotation or the summarisation method can be explored. 
